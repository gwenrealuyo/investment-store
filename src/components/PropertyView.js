...
const PropertyView = () => {
  return (
    <div className="w-full flex flex-col relative z-10">
      {/* Header Section */}
      <header
        className="w-full h-[240px] flex items-center px-[20px] shadow-md justify-around z-20 relative"
      ...
      {/* Neighbor Marker */}
      <div className="absolute left-[1050px] top-[750px] text-blue-500 text-[18px] font-medium">
        Neighbor?
      </div>
